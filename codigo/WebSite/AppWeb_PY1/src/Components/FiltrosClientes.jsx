...
import { obtenerCategoriasClientes, obtenerMetodoDeEntrega } from '../Services/DatosGeneralesAPI.js';

export default function ClienteFiltros({ filtros, onChange, onAplicar, onRestaurar }) {
    ...
    return (
        <div className="bg-emerald-50 shadow-md rounded-md p-6 mb-6 text-slate-800">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <select
                        ...
                        {categorias.map((categorias) => (
                            <option key={categorias.CustomerCategoryID} value={categorias.CustomerCategoryName}>
                ...
                <div>
                    <label className="block text-sm font-medium mb-1">Metodo de entrega</label>
