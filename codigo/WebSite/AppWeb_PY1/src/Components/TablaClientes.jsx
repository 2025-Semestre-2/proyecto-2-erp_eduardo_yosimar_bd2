...
export default function TablaClientes({ clientes }) {
    ...
    const detalleCliente = async (id) => {
        ...
        console.log("Detalles del cliente:",datos);
                ...
                <tbody className="divide-y divide-gray-200">
                    ...
                    {clientesPagina.map((cliente) => (
                        <tr key={cliente.ClienteID}>
                            <td className="px-4 py-2 text-sm text-gray-600">{cliente.ClienteID}</td>
                            <td className="px-4 py-2 text-sm text-gray-800">{cliente.NombreCliente}</td>
                            <td className="px-4 py-2 text-sm text-gray-800">{cliente.Categoria}</td>
                            <td className="px-4 py-2 text-sm text-gray-800">{cliente.MetodoDeEntrega}</td>
